...
| الميزة | الوصف |
|--------|-------|
| 🔒 تشفير قوي | AES‑256‑GCM مع اشتقاق المفتاح **Argon2id**. |
...
| 🌐 10 لغات | English, العربية, Français, Español, Deutsch, 简体中文, Português, فارسی, کوردی, हिन्दी. |
...
- نظام البناء: Gradle 8.13 (KTS)
- التكامل المستمر: Codemagic
- اشتقاق المفتاح: Argon2id (مكتبة argon2kt)
...
*ملاحظة: استخدم `assembleDebug` للاختبار بدون keystore.*
...
| اشتقاق المفتاح | **Argon2id** (128 MiB، 4 دورات، 4 أنوية)، ملح 16 بايت. |
| التعامل مع كلمة المرور | تستخدم CharArray ويتم تصفيرها بعد كل عملية. State كلمة المرور يُمسح فوراً، لكن القيمة قد تبقى في الذاكرة لحين GC. |
